...
func TestGetGradeF(t *testing.T) {
	...
	gradeCalculator.AddGrade("open source assignment", 45, Assignment)
...
func TestGetGradeEmptyList(t *testing.T) {
	expected_value := "F"

	gradeCalculator := NewGradeCalculator()

	gradeCalculator.AddGrade("open source assignment", 0, Assignment)
	// No Exam Score - Assume a student missed an exam and did not make it up.
	// gradeCalculator.AddGrade("exam 1", 35, Exam)

	// I added this statement to get 100% code coverage
